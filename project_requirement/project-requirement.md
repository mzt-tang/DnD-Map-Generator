...
**What limitations are there to achieving the use case?**<br>
We can't use an online database, since it is very difficult to read a JSON file from a relational database.


| User Intention | System Responsibility | User Interface |
| -------------- | --------------------- | -------------- |
| User clicks the save button | The JSON file is saved on a server | Display a 'Saved Game' message |
...
| User Intention | System Responsibility | User Interface |
| -------------- | --------------------- | -------------- |
| User clicks the load game button | The JSON file is retrieved from the server | Displays the map in the same way as it was when saved |
...
- That the server can store the saved game file
