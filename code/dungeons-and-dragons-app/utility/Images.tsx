...
export const getImageWithId = (id: string, index: number, userClicked: MouseEventHandler<HTMLImageElement>): JSX.Element => {
    switch (index) {
        ...
        case 2:
            return <img className="grid_img" src={Image3} id={id} onClick={userClicked}/>
        case 3:
            return <img className="grid_img" src={Image4} id={id} onClick={userClicked}/>
        case 4:
            return <img className="grid_img" src={Image5} id={id} onClick={userClicked}/>
        case 5:
            return <img className="grid_img" src={Image6} id={id} onClick={userClicked}/>
        case 6:
            return <img className="grid_img" src={Image7} id={id} onClick={userClicked}/>
        case 7:
            return <img className="grid_img" src={Image8} id={id} onClick={userClicked}/>
        case 8:
            return <img className="grid_img" src={Image9} id={id} onClick={userClicked}/>
        case 9:
            return <img className="grid_img" src={Image10} id={id} onClick={userClicked}/>
        case 10:
            return <img className="grid_img" src={Image11} id={id} onClick={userClicked}/>
        case 11:
            return <img className="grid_img" src={Image12} id={id} onClick={userClicked}/>
        case 12:
            return <img className="grid_img" src={Image13} id={id} onClick={userClicked}/>
        case 13:
            return <img className="grid_img" src={Image14} id={id} onClick={userClicked}/>
        case 14:
            return <img className="grid_img" src={Image15} id={id} onClick={userClicked}/>
        case 15:
            return <img className="grid_img" src={Image16} id={id} onClick={userClicked}/>
        case 16:
            return <img className="grid_img" src={Image17} id={id} onClick={userClicked}/>
        case 17:
            return <img className="grid_img" src={Image18} id={id} onClick={userClicked}/>
        case 18:
            return <img className="grid_img" src={Image19} id={id} onClick={userClicked}/>
        case 19:
            return <img className="grid_img" src={Image20} id={id} onClick={userClicked}/>
        case 20:
            return <img className="grid_img" src={Image21} id={id} onClick={userClicked}/>
        case 21:
            return <img className="grid_img" src={Image22} id={id} onClick={userClicked}/>
        default:
